              ...
              return Column(
                children: [
                  Container(
                    ...
                    child: CircleImage(
                      // image: profileCubit.profile?.cover?.url?? KImages.placeholder,
                  ...
                  CustomText(
                    text: '${'Guest'} ${'User'}' ,
                    // text: '${profileCubit.profile?.firstName ??'Guest'} ${profileCubit.profile?.lastName ?? 'User'}' ,
                  ...
                  CustomText(
                    ...
                    // text: profileCubit.profile?.email ?? 'guest@email.com',
                    fontSize: 14.0,
                    color: grayColor,
                  ),
