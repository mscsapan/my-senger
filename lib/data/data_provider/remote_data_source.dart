...
abstract class RemoteDataSources {
  ...
  Future sendChatNotification(Map? body,String token);
}
...
class RemoteDataSourcesImpl extends RemoteDataSources {
  ...
  @override
  Future sendChatNotification(Map? body,String token) async {
    final uri = Uri.parse(RemoteUrls.sendChatNotification);
